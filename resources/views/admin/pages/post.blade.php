...
@section('header')
    <link rel="stylesheet" id="css-main" href="{{ asset('js/plugins/summernote/summernote.min.css') }}">
    <link rel="stylesheet" id="css-main" href="{{ asset('js/plugins/summernote/summernote-bs3.min.css') }}">
